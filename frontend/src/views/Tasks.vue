    ...
    <div class="max-w-6xl mx-auto px-8">
      ...
      <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
        ...
        <div v-if="tasksStore.loading" class="p-16 text-center">
          <div
            class="inline-flex items-center justify-center w-12 h-12 border-4 border-gray-200 border-t-gray-900 rounded-full animate-spin mb-4"
          ></div>
        ...
        <div v-else class="divide-y divide-gray-200">
          ...
          >
            <div class="flex items-start space-x-4">
              <!-- Checkbox -->
              <button @click.stop="toggleTask(task)" class="flex-shrink-0 mt-1">
                <div
              ...
              <div class="flex-1 min-w-0">
                <div class="flex items-start justify-between">
                  ...
                  <!-- Action Buttons -->
                  <div
                    class="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 ml-4"
                  >
                    <router-link
