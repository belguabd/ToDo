<template>
          ...
          >
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div v-if="notification.actions && notification.actions.length" class="mt-3 flex items-center space-x-2">
                  <button
  ...
  const mockNotifications = ref([
    ...
    },
    {
      ...
      actions: [
        { label: 'Mark Complete', action: 'complete_task', taskId: 2, primary: true },
  ...
  const filters = computed(() => [
    ...
    { key: 'read', label: 'Read', count: allNotifications.value.length - unreadCount.value }
  ])
  ...
  const removeNotification = (notification) => {
    const index = mockNotifications.value.findIndex(n => n.id === notification.id)
    if (index > -1) {
